    ...
    <div className="babylon-page">
      ...
      <section className="babylon-hero">
        <div className="hero-content">
          <img src="/drexel-portfolio-website/babylon/babylon-logo.JPEG" alt="Babylon Consulting Logo" className="babylon-logo" />
        ...
        <div className="container">
          <div className="about-content">
            ...
            <div className="about-image">
              <img src="/drexel-portfolio-website/babylon/babylon-consulting.JPEG" alt="Babylon Consulting" className="about-img" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="portfolio-grid">
            <div className="portfolio-item">
              <img src="/drexel-portfolio-website/babylon/babylon-letterhead-mockup.JPEG" alt="Babylon Letterhead Mockup" className="portfolio-img" />
            ...
            <div className="portfolio-item">
              <img src="/drexel-portfolio-website/babylon/babylon-sign.JPEG" alt="Babylon Sign" className="portfolio-img" />
              <div className="portfolio-overlay">
