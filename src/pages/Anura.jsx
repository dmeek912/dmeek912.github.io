   ...
   <div className="anura-page">
     ...
     <section className="anura-hero">
       <div className="hero-content">
         <img src="/drexel-portfolio-website/anura/anura-logo.JPEG" alt="Anura Logo" className="anura-logo" />
       ...
       <div className="container">
         <div className="about-content">
           ...
           <div className="about-image">
             <img src="/drexel-portfolio-website/anura/anura-mockup.JPEG" alt="Anura Diving Gear" className="about-img" />
           </div>
         </div>
       </div>
     </section>
       ...
       <div className="container">
         ...
         <div className="portfolio-grid">
           <div className="portfolio-item">
             <img src="/drexel-portfolio-website/anura/anura-mockup2.PNG" alt="Anura Product Mockup" className="portfolio-img" />
           ...
           <div className="portfolio-item">
             <img src="/drexel-portfolio-website/anura/anura-mockup3.JPEG" alt="Anura Gear Mockup" className="portfolio-img" />
             <div className="portfolio-overlay">
